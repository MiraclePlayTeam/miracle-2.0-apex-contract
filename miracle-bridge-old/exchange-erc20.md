...
sequenceDiagram
  ...
  opt Critical Region
  User ->> webWallet(ex. metamask) : erc20.approve(bridgeProxy.address, MAX_SUPPLY) [pre required]
  ...
  Bridge B/E ->> Bridge B/E : grap status = "user_success", and then call bridge.sendERC20ToUser()
  alt success case
  ...
  Admin ->> Bridge B/E : recall bridge.sendERC20ToUser()
